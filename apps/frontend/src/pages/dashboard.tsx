...
export default function DashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
        ...
        <Card>
          <CardContent className="flex flex-col items-center gap-6 pt-6 sm:flex-row sm:items-stretch">
            <div className="flex items-center justify-center sm:border-r sm:border-border sm:pr-6">
              <CalorieRing consumed={totals.calories} target={dietPlan.data.dailyCalorieTarget} />
            </div>
      ...
      {!isLoading && !isError && (
        <div>
          <h2 className="mb-3 font-display text-lg font-semibold text-foreground">Today's meals</h2>
